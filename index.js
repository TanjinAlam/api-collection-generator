...
var GenerateAPICollection = /** @class */ (function () {
    ...
    GenerateAPICollection.prototype.replaceSchemaWithMetadata = function (schemaName, metadata) {
    ...
    GenerateAPICollection.prototype.checkRootNameExist = function (name) {
        if (this.item.length == 0) {
            ...
            return this.item.some(function (element) { return element.name === name; });
            // item.forEach((group) => {
    ...
    GenerateAPICollection.prototype.insertInExistingName = function (name, newItem) {
        var _this = this;
    ...
    GenerateAPICollection.prototype.generateAPICollection = function () {
        for (var endpoint in this.document.paths) {
            ...
            if (this.document.paths[endpoint].delete) {
                ...
                value
                    ? this.insertInExistingName(endpoint.split("/")[1], tempRequestData)
                    : this.createNewName(endpoint.split("/")[1], tempRequestData);
                var deleteRequestBody = this.document.paths[endpoint].delete.requestBody;
        ...
        (collection["info"] = {
            ...
            _collection_link: "https://www.postman.com/chickensartwork/workspace/working/collection/9425168-9fb22a93-fc4b-444f-9b95-f133ee1eff37?action=share&source=collection_link&creator=9425168",
        }),
